use crate::{
    event::ManagedEvent,
    ipv4::{IPv4Address, IPv4ModeData},
    tcpv4::{
        definitions::{
            TCPv4CompletionToken, TCPv4ConfigData, TCPv4ConnectionState, TCPv4IoToken,
            UnmodelledPointer,
        },
        transmit_data::TCPv4TransmitDataHandle,
        TCPv4ConnectionMode,
    },
};
...
pub struct TCPv4Protocol {
    ...
    configure_fn: extern "efiapi" fn(this: &Self, config_data: Option<&TCPv4ConfigData>) -> Status,
    ...
    connect_fn: extern "efiapi" fn(this: &Self, connection_token: &TCPv4CompletionToken) -> Status,

    accept_fn: extern "efiapi" fn(this: &Self, listen_token: &UnmodelledPointer) -> Status,

    pub(crate) transmit_fn: extern "efiapi" fn(this: &Self, token: &TCPv4IoToken) -> Status,

    pub receive_fn: extern "efiapi" fn(this: &Self, token: &TCPv4IoToken) -> Status,

    close_fn: extern "efiapi" fn(this: &Self, close_token: &UnmodelledPointer) -> Status,

    cancel_fn: extern "efiapi" fn(this: &Self, completion_token: &UnmodelledPointer) -> Status,
...
impl TCPv4Protocol {
    ...
    pub fn configure(
        ...
        for _ in 0..10 {
            let result = (self.configure_fn)(self, Some(&configuration));
        ...
        Err(Error::new(
            ...
            "Timeout before configuring the connection succeeded.".to_string(),
        ))
    }
    ...
    pub fn get_tcp_connection_state(&self) -> TCPv4ConnectionState {
        ...
        unsafe {
            ...
            .to_result()
            .expect("Failed to read connection state");
    ...
    pub fn get_ipv4_mode_data(&self) -> IPv4ModeData {
        ...
        unsafe {
            (self.get_mode_data_fn)(self, None, None, Some(&mut *mode_data_ptr), None, None)
                .to_result()
                .expect("Failed to read mode data");
